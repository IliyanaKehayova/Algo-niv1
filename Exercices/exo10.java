...
public class exo10{
    public static void main(String [] args){
        ...
        if(answer1.equalsIgnoreCase("VRAI")){System.out.print("Bonne réponse, vous avez gagné 1 point. \n"); 
        score++;}
        ...
        if(answer2.equalsIgnoreCase("VRAI")){System.out.print("Bonne réponse, vous avez gagné 1 point. \n");
        score++;}
        else{System.out.print("Mauvaise réponse, vous ne gagnez pas de point. \n");};

        System.out.println("QUESTION 3 : L'Allemagne est le pays le plus peuple au monde ? VRAI/FAUX");
        String answer3 = clavier.nextLine();
        if(answer3.equalsIgnoreCase("FAUX")){System.out.print("Bonne réponse, vous avez gagné 1 point. \n");
        score++;}
        else{System.out.print("Mauvaise réponse, vous ne gagnez pas de point. \n");};

        System.out.println("Question 4: La ville de Tokyo se trouve en Europe ? VRAI/FAUX");
        String answer4 = clavier.nextLine();
        if(answer4.equalsIgnoreCase("FAUX")){System.out.print("Bonne réponse, vous avez gagné 1 point. \n");
        score++;}
        else{System.out.print("Mauvaise réponse, vous ne gagnez pas de point. \n");};

        System.out.println("QUESTION 5 : Le Dalai Lama vient de Tibet ? VRAI/FAUX");
        String answer5 = clavier.nextLine();
        if(answer5.equalsIgnoreCase("VRAI")){System.out.print("Bonne réponse, vous avez gagné 1 point. \n");
        score++;}
        else{System.out.print("Mauvaise réponse, vous ne gagnez pas de point. \n");};
